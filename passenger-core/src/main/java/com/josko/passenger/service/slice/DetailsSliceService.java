...
public class DetailsSliceService implements SliceService<PassengerDetailsData> {
    ...
    private void updateDetailsData(final PassengerDetailsEntity detailsData, UpdateMetaData metaData, final PassengerDetailsData data) {
        detailsMapper.update(detailsData, data, metaData);
        detailsRepository.save(detailsData);
    }
